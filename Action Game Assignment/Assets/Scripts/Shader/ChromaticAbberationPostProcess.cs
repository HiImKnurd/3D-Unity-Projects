...
public class ChromaticAberrationPostProcess : VolumeComponent, IPostProcessComponent
{
    ...
    public FloatParameter hardness = new ClampedFloatParameter(1.0f, 0f, 5f);
    public FloatParameter intensity = new ClampedFloatParameter(1.0f, 0f, 5f);
    public FloatParameter redOffset = new ClampedFloatParameter(0f, 0f, 10f);
    public FloatParameter blueOffset = new ClampedFloatParameter(0f, 0f, 10f);
    public FloatParameter greenOffset = new ClampedFloatParameter(0f, 0f, 10f);
